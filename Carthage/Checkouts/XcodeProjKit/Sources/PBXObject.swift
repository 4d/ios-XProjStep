...
public typealias XcodeRef = String
...
public /* abstract */ class PBXObject {
    ...
    public required init(ref: XcodeRef, fields: PBXObject.Fields, objects: PBXObjectFactory) {
...
extension PBXObject {
    ...
    func string(_ key: XcodeRef) -> String? {
    ...
    func strings(_ key: XcodeRef) -> [String] {
...
public protocol PBXObjectFactory {
    ...
    func object<T: PBXObject>(_ ref: XcodeRef) -> T?
...
extension PBXObject: PBXObjectFactory {
    ...
    public func object<T: PBXObject>(_ key: XcodeRef) -> T? {
    ...
    func objects<T: PBXObject>(_ key: XcodeRef) -> [T] {
